...
import { deserializeGenerationState } from "@openbuilder/agent-core/lib/generation-persistence";
import {
  detectOperationType,
  createFreshGenerationState,
  validateGenerationState,
  createInitialCodexSessionState,
} from "@openbuilder/agent-core/lib/build-helpers";
import { processCodexEvent } from "@openbuilder/agent-core/lib/agents/codex/events";
...
import { getClaudeModelLabel } from "@openbuilder/agent-core/client";
import { deserializeTags, serializeTags } from "@openbuilder/agent-core/lib/tags/serialization";
...
- Text: ${element.textContent?.substring(0, 100) || 'none'}` : '';
  ...
  // (apps/openbuilder/src/app/api/runner/events/route.ts lines 638-710)
