...
import { resolveAgentStrategy, type AgentStrategyContext } from '@hatchway/agent-core/lib/agents';
...
- For Vite projects, ensure \`vite.config.*\` accepts the preview host:
